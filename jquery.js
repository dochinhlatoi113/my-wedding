 ...
 * https://modernizr.com/download/?-applicationcache-audio-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-flexbox-fontface-generatedcontent-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-multiplebgs-opacity-postmessage-rgba-sessionstorage-smil-svg-svgclippaths-textshadow-video-webgl-websockets-websqldatabase-webworkers-addtest-domprefixes-hasevent-mq-prefixed-prefixes-setclasses-shiv-testallprops-testprop-teststyles !*/
 ! function(e, t, n) {
	...
	var T = [],
		...
		Modernizr = function() {};
	Modernizr.prototype = S, Modernizr = new Modernizr, Modernizr.addTest("geolocation", "geolocation" in navigator), Modernizr.addTest("history", function() {
		var t = navigator.userAgent;
		return -1 === t.indexOf("Android 2.") && -1 === t.indexOf("Android 4.0") || -1 === t.indexOf("Mobile Safari") || -1 !== t.indexOf("Chrome") || -1 !== t.indexOf("Windows Phone") || "file:" === location.protocol ? e.history && "pushState" in e.history : !1
	}), Modernizr.addTest("applicationcache", "applicationCache" in e), Modernizr.addTest("postmessage", "postMessage" in e), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
	var C = !1;
	try {
	...
	var J = S.prefixed = function(e, t, n) {
		return 0 === e.indexOf("@") ? W(e) : (-1 != e.indexOf("-") && (e = c(e)), t ? y(e, t, n) : y(e, "pfx"))
	};
	...
	return b.defaults = {
		...
		g.onload = function() {
			...
			f.attr({
				alt: c.album[b].alt,
				src: d
			}), a(g), f.width(g.width), f.height(g.height), m = a(window).width(), l = a(window).height(), k = m - c.containerPadding.left - c.containerPadding.right - c.imageBorderWidth.left - c.imageBorderWidth.right - 40, j = l - c.containerPadding.top - c.containerPadding.bottom - c.imageBorderWidth.top - c.imageBorderWidth.bottom - c.options.positionFromTop - 70, "svg" === e && (f.width(k), f.height(j)), c.options.fitImagesInViewport ? (c.options.maxWidth && c.options.maxWidth < k && (k = c.options.maxWidth), c.options.maxHeight && c.options.maxHeight < j && (j = c.options.maxHeight)) : (k = c.options.maxWidth || g.width || k, j = c.options.maxHeight || g.height || j), (g.width > k || g.height > j) && (g.width / k > g.height / j ? (i = k, h = parseInt(g.height / (g.width / i), 10), f.width(i), f.height(h)) : (h = j, i = parseInt(g.width / (g.height / h), 10), f.width(i), f.height(h))), c.sizeContainer(f.width(), f.height())
		...
		this.disableKeyboardNav(), a(window).off("resize", this.sizeOverlay), this.$lightbox.fadeOut(this.options.fadeDuration), this.$overlay.fadeOut(this.options.fadeDuration), this.options.disableScrolling && a("html").removeClass("lb-disable-scrolling")
	}, new b
});
...
! function(e) {
	...
	function m() {
		...
		for (s = 0; s < n.length; s++)
			if (n[s] in r) {
				i.transitionstyle = n[s], i.prefixstyle = l[s], i.transitionend = a[s];
				break
			} return i.ischrome26 && (i.prefixstyle = l[1]), i.hastransition = i.transitionstyle, i.cursorgrabvalue = function() {
	...
	function i(e, o) {
		...
		this.synched = function(e, o) {
			return g.synclist[e] = o, i || (h(function() {
			...
			tx: "0px",
			ty: "0px"
		}, f.hastranslate3d && f.isios && this.doc.css("-webkit-backface-visibility", "hidden"), this.getScrollTop = function(e) {
			if (!e) {
				e = n();
		...
		}, r = this.isrtlmode ? 1 : -1, f.hastranslate3d && g.opt.enabletranslate3d ? (this.setScrollTop = function(e, o) {
			g.doc.translate.y = e, g.doc.translate.ty = -1 * e + "px", g.doc.css(f.trstyle, "translate3d(" + g.doc.translate.tx + "," + g.doc.translate.ty + ",0px)"), o || g.notifyScrollEvent(g.win[0])
		}, this.setScrollLeft = function(e, o) {
			g.doc.translate.x = e, g.doc.translate.tx = e * r + "px", g.doc.css(f.trstyle, "translate3d(" + g.doc.translate.tx + "," + g.doc.translate.ty + ",0px)"), o || g.notifyScrollEvent(g.win[0])
		}) : (this.setScrollTop = function(e, o) {
			g.doc.translate.y = e, g.doc.translate.ty = -1 * e + "px", g.doc.css(f.trstyle, "translate(" + g.doc.translate.tx + "," + g.doc.translate.ty + ")"), o || g.notifyScrollEvent(g.win[0])
		}, this.setScrollLeft = function(e, o) {
			g.doc.translate.x = e, g.doc.translate.tx = e * r + "px", g.doc.css(f.trstyle, "translate(" + g.doc.translate.tx + "," + g.doc.translate.ty + ")"), o || g.notifyScrollEvent(g.win[0])
		...
		function d(e, o, t) {
			...
			if (0 == e.deltaMode ? (r = -Math.floor(e.deltaX * (g.opt.mousescrollstep / 54)), i = -Math.floor(e.deltaY * (g.opt.mousescrollstep / 54))) : 1 == e.deltaMode && (r = -Math.floor(e.deltaX * g.opt.mousescrollstep), i = -Math.floor(e.deltaY * g.opt.mousescrollstep)), o && g.opt.oneaxismousemode && 0 == r && i && (r = i, i = 0, t && (r < 0 ? g.getScrollLeft() >= g.page.maxw : g.getScrollLeft() <= 0) && (i = r, r = 0)), r && (g.scrollmom && g.scrollmom.stop(), g.lastdeltax += r, g.debounced("mousewheelx", function() {
				...
				g.scrollmom && g.scrollmom.stop(), g.lastdeltay += i, g.debounced("mousewheely", function() {
					var e = g.lastdeltay;
		...
		this.getDocumentScrollOffset = function() {
			...
			g.ishwscroll ? (g.rail.css({
			...
			}).top += l(g.win, "border-top-width", !0), r.left += g.rail.align ? g.win.outerWidth() - l(g.win, "border-right-width") - g.rail.width : l(g.win, "border-left-width"), (t = g.opt.railoffset) && (t.top && (r.top += t.top), g.rail.align && t.left && (r.left += t.left)), g.railslocked || g.rail.css({
				top: r.top,
				left: r.left,
				...
				top: o.top,
				left: o.left
			}, (t = g.opt.railhoffset) && (t.top && (r.top += t.top), t.left && (r.left += t.left)), t = g.railh.align ? r.top + l(g.win, "border-top-width", !0) + g.win.innerHeight() - g.railh.height : r.top + l(g.win, "border-top-width", !0), r = r.left + l(g.win, "border-left-width"), g.railh.css({
			...
			var r, i;
			g.railslocked || (g.cancelEvent(e), o ? (r = t ? g.doScrollLeft : g.doScrollTop)(i = t ? (e.pageX - g.railh.offset().left - g.cursorwidth / 2) * g.scrollratio.x : (e.pageY - g.rail.offset().top - g.cursorheight / 2) * g.scrollratio.y) : (r = t ? g.doScrollLeftBy : g.doScrollBy, i = t ? g.scroll.x : g.scroll.y, e = t ? e.pageX - g.railh.offset().left : e.pageY - g.rail.offset().top, t = t ? g.view.w : g.view.h, r(e <= i ? t : -t)))
		}, g.hasanimationframe = h, g.hascancelanimationframe = p, g.hasanimationframe ? g.hascancelanimationframe || (p = function() {
			...
			if (f.hasmstouch && g.css(g.ispage ? x("html") : g.win, {
				...
				}), g.zindex = "auto", g.ispage || "auto" != g.opt.zindex ? g.zindex = g.opt.zindex : g.zindex = function() {
					var e = g.win;
					...
					return !1
				}() || "auto", g.ispage || "auto" == g.zindex || g.zindex > y && (y = g.zindex), g.isie && 0 == g.zindex && "auto" == g.opt.zindex && (g.zindex = "auto"), !g.ispage || !f.cantouch && !f.isieold && !f.isie9mobile) {
				var e = g.docscroll;
				g.ispage && (e = g.haswrapper ? g.win : g.doc), f.isie9mobile || g.css(e, {
					"overflow-y": "hidden"
				...
				}), o.hborder = parseFloat(o.outerHeight() - o.innerHeight()), o.addClass("nicescroll-cursors"), g.cursor = o;
				var t = x(document.createElement("div"));
				t.attr("id", g.id), t.addClass("nicescroll-rails nicescroll-rails-vr");
				var r, i, n, s = ["left", "right", "top", "bottom"];
				for (n in s) i = s[n], (r = g.opt.railpadding[i]) ? t.css("padding-" + i, r + "px") : g.opt.railpadding[i] = 0;
				t.append(o), t.width = Math.max(parseFloat(g.opt.cursorwidth), o.outerWidth()), t.css({
					width: t.width + "px",
					zIndex: g.zindex,
					background: g.opt.background,
					cursor: "default"
				}), t.visibility = !0, t.scrollable = !0, t.align = "left" == g.opt.railalign ? 0 : 1, g.rail = t;
				var l, a, c, d, u, h, p = g.rail.drag = !1;
				!g.opt.boxzoom || g.ispage || f.isieold || (p = document.createElement("div"), g.bind(p, "click", g.doZoom), g.bind(p, "mouseenter", function() {
					g.zoom.css("opacity", g.opt.cursoropacitymax)
				}), g.bind(p, "mouseleave", function() {
					g.zoom.css("opacity", g.opt.cursoropacitymin)
				}), g.zoom = x(p), g.zoom.css({
					cursor: "pointer",
					"z-index": g.zindex,
				...
				}), g.opt.dblclickzoom && g.bind(g.win, "dblclick", g.doZoom), f.cantouch && g.opt.gesturezoom && (g.ongesturezoom = function(e) {
					return 1.5 < e.scale && g.doZoomIn(e), e.scale < .8 && g.doZoomOut(e), g.cancelEvent(e)
				}, g.bind(g.win, "gestureend", g.ongesturezoom))), g.railh = !1, g.opt.horizrailenabled && (g.css(e, {
					"overflow-x": "hidden"
					...
					overflow: "hidden"
				}), o.wborder = parseFloat(o.outerWidth() - o.innerWidth()), o.addClass("nicescroll-cursors"), g.cursorh = o, (a = x(document.createElement("div"))).attr("id", g.id + "-hr"), a.addClass("nicescroll-rails nicescroll-rails-hr"), a.height = Math.max(parseFloat(g.opt.cursorwidth), o.outerHeight()), a.css({
					height: a.height + "px",
					zIndex: g.zindex,
					background: g.opt.background
				}), a.append(o), a.visibility = !0, a.scrollable = !0, a.align = "top" == g.opt.railvalign ? 0 : 1, g.railh = a, g.railh.drag = !1), g.ispage ? (t.css({
					position: "fixed",
					top: "0px",
					height: "100%"
				}), t.align ? t.css({
					...
					position: "relative"
				}), l = "HTML" == g.win[0].nodeName ? g.body : g.win, x(l).scrollTop(0).scrollLeft(0), g.zoom && (g.zoom.css({
					position: "absolute",
					top: 1,
					right: 0,
					"margin-right": t.width + 4
				}), l.append(g.zoom)), t.css({
					position: "absolute",
					top: 0
				}), t.align ? t.css({
					right: 0
					...
					top: 0
				}), l.append(a))) : (g.isfixed = "fixed" == g.win.css("position"), l = g.isfixed ? "fixed" : "absolute", g.isfixed || (g.viewport = g.getViewport(g.win[0])), g.viewport && (g.body = g.viewport, 0 == /fixed|absolute/.test(g.viewport.css("position")) && g.css(g.viewport, {
					position: "relative"
				})), t.css({
					position: l
				}), g.zoom && g.zoom.css({
					position: l
				}), g.updateScrollBar(), g.body.append(t), g.zoom && g.body.append(g.zoom), g.railh && (a.css({
					position: l
				}), g.body.append(a))), f.isios && g.css(g.win, {
					"-webkit-tap-highlight-color": "rgba(0,0,0,0)",
					"-webkit-touch-callout": "none"
				}), f.isie && g.opt.disableoutline && g.win.attr("hideFocus", "true"), f.iswebkit && g.opt.disableoutline && g.win.css({
					outline: "none"
				})), !1 === g.opt.autohidemode ? (g.autohidedom = !1, g.rail.css({
					opacity: g.opt.cursoropacitymax
				}), g.railh && g.railh.css({
					opacity: g.opt.cursoropacitymax
				})) : !0 === g.opt.autohidemode || "leave" === g.opt.autohidemode ? (g.autohidedom = x().add(g.rail), f.isie8 && (g.autohidedom = g.autohidedom.add(g.cursor)), g.railh && (g.autohidedom = g.autohidedom.add(g.railh)), g.railh && f.isie8 && (g.autohidedom = g.autohidedom.add(g.cursorh))) : "scroll" == g.opt.autohidemode ? (g.autohidedom = x().add(g.rail), g.railh && (g.autohidedom = g.autohidedom.add(g.railh))) : "cursor" == g.opt.autohidemode ? (g.autohidedom = x().add(g.cursor), g.railh && (g.autohidedom = g.autohidedom.add(g.cursorh))) : "hidden" == g.opt.autohidemode && (g.autohidedom = !1, g.hide(), g.railslocked = !1), f.isie9mobile ? (g.scrollmom = new T(g), g.onmangotouch = function() {
					var e = g.getScrollTop(),
						o = g.getScrollLeft();
					if (e == g.scrollmom.lastscrolly && o == g.scrollmom.lastscrollx) return !0;
					var t, r, i, n = e - g.mangotouch.sy,
						s = o - g.mangotouch.sx;
					0 != Math.round(Math.sqrt(Math.pow(s, 2) + Math.pow(n, 2))) && (t = n < 0 ? -1 : 1, r = s < 0 ? -1 : 1, i = +new Date, g.mangotouch.lazy && clearTimeout(g.mangotouch.lazy), 80 < i - g.mangotouch.tm || g.mangotouch.dry != t || g.mangotouch.drx != r ? (g.scrollmom.stop(), g.scrollmom.reset(o, e), g.mangotouch.sy = e, g.mangotouch.ly = e, g.mangotouch.sx = o, g.mangotouch.lx = o, g.mangotouch.dry = t, g.mangotouch.drx = r, g.mangotouch.tm = i) : (g.scrollmom.stop(), g.scrollmom.update(g.mangotouch.sx - s, g.mangotouch.sy - n), g.mangotouch.tm = i, i = Math.max(Math.abs(g.mangotouch.ly - e), Math.abs(g.mangotouch.lx - o)), g.mangotouch.ly = e, g.mangotouch.lx = o, 2 < i && (g.mangotouch.lazy = setTimeout(function() {
						g.mangotouch.lazy = !1, g.mangotouch.dry = 0, g.mangotouch.drx = 0, g.mangotouch.tm = 0, g.scrollmom.doMomentum(30)
					}, 100))))
				}, a = g.getScrollTop(), h = g.getScrollLeft(), g.mangotouch = {
					sy: a,
					ly: a,
					dry: 0,
					sx: h,
					...
					lazy: !1,
					tm: 0
				}, g.bind(g.docscroll, "scroll", g.onmangotouch)) : ((f.cantouch || g.istouchcapable || g.opt.touchbehavior || f.hasmstouch) && (g.scrollmom = new T(g), g.ontouchstart = function(e) {
					...
					if (g.hasmoving = !1, !g.railslocked) {
						...
						if (g.cancelScroll(), o = g.getTarget(e), o)
							if (/INPUT/i.test(o.nodeName) && /range/i.test(o.type)) return g.stopPropagation(e);
						if (!("clientX" in e) && "changedTouches" in e && (e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY), g.forcescreen && ((e = {
								original: (r = e).original || e
							}).clientX = r.screenX, e.clientY = r.screenY), g.rail.drag = {
								x: e.clientX,
								y: e.clientY,
								sx: g.scroll.x,
								sy: g.scroll.y,
								...
								pt: 2,
								dl: !1
							}, g.ispage || !g.opt.directionlockdeadzone ? g.rail.drag.dl = "f" : (n = x(window).width(), i = x(window).height(), t = Math.max(document.body.scrollWidth, document.documentElement.scrollWidth), r = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight), i = Math.max(0, r - i), n = Math.max(0, t - n), !g.rail.scrollable && g.railh.scrollable ? g.rail.drag.ck = 0 < i && "v" : g.rail.scrollable && !g.railh.scrollable ? g.rail.drag.ck = 0 < n && "h" : g.rail.drag.ck = !1, g.rail.drag.ck || (g.rail.drag.dl = "f")), g.opt.touchbehavior && g.isiframe && f.isie && (n = g.win.position(), g.rail.drag.x += n.left, g.rail.drag.y += n.top), g.hasmoving = !1, g.lastmouseup = !1, g.scrollmom.reset(e.clientX, e.clientY), !f.cantouch && !this.istouchcapable && !e.pointerType) {
							if (!(!!o && /INPUT|SELECT|TEXTAREA/i.test(o.nodeName))) return !g.ispage && f.hasmousecapture && o.setCapture(), g.opt.touchbehavior ? (o.onclick && !o._onclick && (o._onclick = o.onclick, o.onclick = function(e) {
					...
					return !g.rail.drag || (2 == g.rail.drag.pt ? (!e.pointerType || 2 == e.pointerType || "touch" == e.pointerType) && (g.scrollmom.doMomentum(), g.rail.drag = !1, g.hasmoving && (g.lastmouseup = !0, g.hideCursor(), f.hasmousecapture && document.releaseCapture(), !f.cantouch) ? g.cancelEvent(e) : void 0) : 1 == g.rail.drag.pt ? g.onmouseup(e) : void 0)
				}, c = g.opt.touchbehavior && g.isiframe && !f.hasmousecapture, g.ontouchmove = function(e, o) {
					if (!g.rail.drag) return !1;
					if (e.targetTouches && g.opt.preventmultitouchscrolling && 1 < e.targetTouches.length) return !1;
					if (e.pointerType && 2 != e.pointerType && "touch" != e.pointerType) return !1;
					if (2 != g.rail.drag.pt) return 1 == g.rail.drag.pt ? g.onmousemove(e) : void 0;
					if (f.cantouch && f.isios && void 0 === e.original) return !0;
					g.hasmoving = !0, g.preventclick && !g.preventclick.click && (g.preventclick.click = g.preventclick.tg.onclick || !1, g.preventclick.tg.onclick = g.onpreventclick), "changedTouches" in (e = x.extend({
						original: e
					}, e)) && (e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY), g.forcescreen && ((e = {
						original: (a = e).original || e
					}).clientX = a.screenX, e.clientY = a.screenY), a = l = 0, c && !o && (a = -(n = g.win.position()).left, l = -n.top);
					var t, r = e.clientY + l,
						o = r - g.rail.drag.y,
						i = e.clientX + a,
						n = i - g.rail.drag.x,
						s = g.rail.drag.st - o;
					g.ishwscroll && g.opt.bouncescroll ? s < 0 ? s = Math.round(s / 2) : s > g.page.maxh && (s = g.page.maxh + Math.round((s - g.page.maxh) / 2)) : (s < 0 && (r = s = 0), s > g.page.maxh && (s = g.page.maxh, r = 0)), g.railh && g.railh.scrollable && (t = g.isrtlmode ? n - g.rail.drag.sl : g.rail.drag.sl - n, g.ishwscroll && g.opt.bouncescroll ? t < 0 ? t = Math.round(t / 2) : t > g.page.maxw && (t = g.page.maxw + Math.round((t - g.page.maxw) / 2)) : (t < 0 && (i = t = 0), t > g.page.maxw && (t = g.page.maxw, i = 0)));
					var l = !1;
					if (g.rail.drag.dl) l = !0, "v" == g.rail.drag.dl ? t = g.rail.drag.sl : "h" == g.rail.drag.dl && (s = g.rail.drag.st);
					else {
						var a = Math.abs(o),
							o = Math.abs(n),
							n = g.opt.directionlockdeadzone;
						if ("v" == g.rail.drag.ck) {
							if (n < a && o <= .3 * a) return !(g.rail.drag = !1);
							n < o && (g.rail.drag.dl = "f", x("body").scrollTop(x("body").scrollTop()))
						} else if ("h" == g.rail.drag.ck) {
							if (n < o && a <= .3 * o) return !(g.rail.drag = !1);
							n < a && (g.rail.drag.dl = "f", x("body").scrollLeft(x("body").scrollLeft()))
						}
					}
					return g.synched("touchmove", function() {
						g.rail.drag && 2 == g.rail.drag.pt && (g.prepareTransition && g.prepareTransition(0), g.rail.scrollable && g.setScrollTop(s), g.scrollmom.update(i, r), g.railh && g.railh.scrollable ? (g.setScrollLeft(t), g.showCursor(s, t)) : g.showCursor(s), f.isie10 && document.selection.clear())
					}), f.ischrome && g.istouchcapable && (l = !1), l ? g.cancelEvent(e) : void 0
				}), g.onmousedown = function(e, o) {
					if (!g.rail.drag || 1 == g.rail.drag.pt) {
						if (g.railslocked) return g.cancelEvent(e);
						g.cancelScroll(), g.rail.drag = {
							x: e.clientX,
							y: e.clientY,
							sx: g.scroll.x,
							sy: g.scroll.y,
						...
						o = g.getTarget(e);
						return !g.ispage && f.hasmousecapture && o.setCapture(), g.isiframe && !f.hasmousecapture && (g.saved.csspointerevents = g.doc.css("pointer-events"), g.css(g.doc, {
							"pointer-events": "none"
						})), g.hasmoving = !1, g.cancelEvent(e)
					}
				}, g.onmouseup = function(e) {
					if (g.rail.drag) return 1 != g.rail.drag.pt || (f.hasmousecapture && document.releaseCapture(), g.isiframe && !f.hasmousecapture && g.doc.css("pointer-events", g.saved.csspointerevents), g.rail.drag = !1, g.hasmoving && g.triggerScrollEnd(), g.cancelEvent(e))
				}, g.onmousemove = function(e) {
					var o;
					if (g.rail.drag && 1 == g.rail.drag.pt) return f.ischrome && 0 == e.which ? g.onmouseup(e) : (g.cursorfreezed = !0, g.hasmoving = !0, g.rail.drag.hr ? (g.scroll.x = g.rail.drag.sx + (e.clientX - g.rail.drag.x), g.scroll.x < 0 && (g.scroll.x = 0), o = g.scrollvaluemaxw, g.scroll.x > o && (g.scroll.x = o)) : (g.scroll.y = g.rail.drag.sy + (e.clientY - g.rail.drag.y), g.scroll.y < 0 && (g.scroll.y = 0), o = g.scrollvaluemax, g.scroll.y > o && (g.scroll.y = o)), g.synched("mousemove", function() {
						g.rail.drag && 1 == g.rail.drag.pt && (g.showCursor(), g.rail.drag.hr ? g.hasreversehr ? g.doScrollLeft(g.scrollvaluemaxw - Math.round(g.scroll.x * g.scrollratio.x), g.opt.cursordragspeed) : g.doScrollLeft(Math.round(g.scroll.x * g.scrollratio.x), g.opt.cursordragspeed) : g.doScrollTop(Math.round(g.scroll.y * g.scrollratio.y), g.opt.cursordragspeed))
					}), g.cancelEvent(e))
				}, f.cantouch || g.opt.touchbehavior ? (g.onpreventclick = function(e) {
					if (g.preventclick) return g.preventclick.tg.onclick = g.preventclick.click, g.preventclick = !1, g.cancelEvent(e)
				}, g.bind(g.win, "mousedown", g.ontouchstart), g.onclick = !f.isios && function(e) {
					return !g.lastmouseup || (g.lastmouseup = !1, g.cancelEvent(e))
					...
					var o, t;
					g.selectiondrag && (e && (o = g.win.outerHeight(), 0 < (t = e.pageY - g.selectiondrag.top) && t < o && (t = 0), o <= t && (t -= o), g.selectiondrag.df = t), 0 != g.selectiondrag.df && (t = 2 * -Math.floor(g.selectiondrag.df / 6), g.doScrollBy(t), g.debounced("doselectionscroll", function() {
						d()
					}, 50)))
					...
					"touch-action": "none"
				}), g.bind(g.win, "pointerdown", g.ontouchstart), g.bind(document, "pointerup", g.ontouchend), g.bind(document, "pointermove", g.ontouchmove)) : f.hasmstouch ? (g.css(g.rail, {
					"-ms-touch-action": "none"
				}), g.css(g.cursor, {
					"-ms-touch-action": "none"
				}), g.bind(g.win, "MSPointerDown", g.ontouchstart), g.bind(document, "MSPointerUp", g.ontouchend), g.bind(document, "MSPointerMove", g.ontouchmove), g.bind(g.cursor, "MSGestureHold", function(e) {
					e.preventDefault()
				}), g.bind(g.cursor, "contextmenu", function(e) {
					e.preventDefault()
				})) : this.istouchcapable && (g.bind(g.win, "touchstart", g.ontouchstart), g.bind(document, "touchend", g.ontouchend), g.bind(document, "touchcancel", g.ontouchend), g.bind(document, "touchmove", g.ontouchmove)), !g.opt.cursordragontouch && (f.cantouch || g.opt.touchbehavior) || (g.rail.css({
					cursor: "default"
				}), g.railh && g.railh.css({
					cursor: "default"
				}), g.jqbind(g.rail, "mouseenter", function() {
					return !(!g.ispage && !g.win.is(":visible")) && (g.canshowonmouseevent && g.showCursor(), void(g.rail.active = !0))
					...
					g.cancelEvent(e)
				})))), f.cantouch || g.opt.touchbehavior ? (g.bind(f.hasmousecapture ? g.win : document, "mouseup", g.ontouchend), g.bind(document, "mousemove", g.ontouchmove), g.onclick && g.bind(document, "click", g.onclick), g.opt.cursordragontouch && (g.bind(g.cursor, "mousedown", g.onmousedown), g.bind(g.cursor, "mouseup", g.onmouseup), g.cursorh && g.bind(g.cursorh, "mousedown", function(e) {
					g.onmousedown(e, !0)
				}), g.cursorh && g.bind(g.cursorh, "mouseup", g.onmouseup))) : (g.bind(f.hasmousecapture ? g.win : document, "mouseup", g.onmouseup), g.bind(document, "mousemove", g.onmousemove), g.onclick && g.bind(document, "click", g.onclick), g.bind(g.cursor, "mousedown", g.onmousedown), g.bind(g.cursor, "mouseup", g.onmouseup), g.railh && (g.bind(g.cursorh, "mousedown", function(e) {
					g.onmousedown(e, !0)
				}), g.bind(g.cursorh, "mouseup", g.onmouseup)), !g.ispage && g.opt.enablescrollonselection && (g.bind(g.win[0], "mousedown", g.onselectionstart), g.bind(document, "mouseup", g.onselectionend), g.bind(g.cursor, "mouseup", g.onselectionend), g.cursorh && g.bind(g.cursorh, "mouseup", g.onselectionend), g.bind(document, "mousemove", g.onselectiondrag)), g.zoom && (g.jqbind(g.zoom, "mouseenter", function() {
					g.canshowonmouseevent && g.showCursor(), g.rail.active = !0
				}), g.jqbind(g.zoom, "mouseleave", function() {
					g.rail.active = !1, g.rail.drag || g.hideCursor()
				}))), g.opt.enablemousewheel && (g.isiframe || g.bind(f.isie && g.ispage ? document : g.win, "mousewheel", g.onmousewheel), g.bind(g.rail, "mousewheel", g.onmousewheel), g.railh && g.bind(g.railh, "mousewheel", g.onmousewheelhr)), g.ispage || f.cantouch || /HTML|^BODY/.test(g.win[0].nodeName) || (g.win.attr("tabindex") || g.win.attr({
					tabindex: b++
				}), g.jqbind(g.win, "focus", function(e) {
					w = g.getTarget(e).id || !0, g.hasfocus = !0, g.canshowonmouseevent && g.noticeCursor()
				}), g.jqbind(g.win, "blur", function(e) {
					w = !1, g.hasfocus = !1
				}), g.jqbind(g.win, "mouseenter", function(e) {
					v = g.getTarget(e).id || !0, g.hasmousefocus = !0, g.canshowonmouseevent && g.noticeCursor()
				}), g.jqbind(g.win, "mouseleave", function() {
					v = !1, g.hasmousefocus = !1, g.rail.drag || g.hideCursor()
					...
					if (g.hasfocus || g.hasmousefocus && !w || g.ispage && !w && !v) {
						...
						switch (o) {
							...
							case 37:
							case 63232:
								g.railh && (t ? g.doScrollLeft(0) : g.doScrollLeftBy(72), i = !0);
								break;
							case 39:
							case 63234:
								g.railh && (t ? g.doScrollLeft(g.page.maxw) : g.doScrollLeftBy(-72), i = !0);
								break;
							case 33:
							case 63276:
							...
							case 36:
							case 63273:
								g.railh && t ? g.doScrollPos(0, 0) : g.doScrollTo(0), i = !0;
								break;
							case 35:
							case 63275:
								g.railh && t ? g.doScrollPos(g.page.maxw, g.page.maxh) : g.doScrollTo(g.page.maxh), i = !0;
								break;
							case 32:
								g.opt.spacebarenabled && (r ? g.doScrollBy(g.view.h) : g.doScrollBy(-g.view.h), i = !0);
								break;
							case 27:
				...
				}, g.opt.enablekeyboard && g.bind(document, f.isopera && !f.isopera12 ? "keypress" : "keydown", g.onkeypress), g.bind(document, "keydown", function(e) {
					...
					g.wheelprevented = !1
				}), g.bind(window, "resize", g.lazyResize), g.bind(window, "orientationchange", g.lazyResize), g.bind(window, "load", g.lazyResize), !f.ischrome || g.ispage || g.haswrapper || (u = g.win.attr("style"), h = parseFloat(g.win.css("width")) + 1, g.win.css("width", h), g.synched("chromefix", function() {
					g.win.attr("style", u)
				})), !(g.onAttributeChange = function(e) {
					g.lazyResize(g.isieold ? 250 : 30)
				}) !== S && (g.observerbody = new S(function(e) {
					if (e.forEach(function(e) {
							if ("attributes" == e.type) return x("body").hasClass("modal-open") ? g.hide() : g.show()
						}), document.body.scrollHeight != g.page.maxh) return g.lazyResize(30)
					...
					e.forEach(function(e) {
						if (0 < e.removedNodes.length)
							for (var o in e.removedNodes)
								if (g && e.removedNodes[o] == g.win[0]) return g.remove()
					})
					...
					attributes: !1,
					subtree: !1
				})) : (g.bind(g.win, f.isie && !f.isie9 ? "propertychange" : "DOMAttrModified", g.onAttributeChange), f.isie9 && g.win[0].attachEvent("onpropertychange", g.onAttributeChange), g.bind(g.win, "DOMNodeRemoved", function(e) {
					e.target == g.win[0] && g.remove()
				}))), !g.ispage && g.opt.boxzoom && g.bind(window, "resize", g.resizeZoom), g.istextarea && g.bind(g.win, "mouseup", g.lazyResize), g.lazyResize(30)
			}
			var m;
			"IFRAME" == this.doc[0].nodeName && (m = function() {
				...
				g.forcescreen = !0, g.isiframe && (g.iframe = {
					doc: x(o),
				...
				}, g.docscroll = x(g.iframe.body)), f.isios || !g.opt.iframeautoresize || g.isiframe || (g.win.scrollTop(0), g.doc.height(""), e = Math.max(o.getElementsByTagName("html")[0].scrollHeight, o.body.scrollHeight), g.doc.height(e)), g.lazyResize(30), f.isie7 && g.css(x(g.iframe.html), {
					"overflow-y": "hidden"
				}), g.css(x(g.iframe.body), {
					"overflow-y": "hidden"
				}), f.isios && g.haswrapper && g.css(x(o.body), {
					"-webkit-transform": "translate3d(0,0,0)"
				}), "contentWindow" in this ? g.bind(this.contentWindow, "scroll", g.onscroll) : g.bind(o, "scroll", g.onscroll), g.opt.enablemousewheel && g.bind(o, "mousewheel", g.onmousewheel), g.opt.enablekeyboard && g.bind(o, f.isopera ? "keypress" : "keydown", g.onkeypress), (f.cantouch || g.opt.touchbehavior) && (g.bind(o, "mousedown", g.ontouchstart), g.bind(o, "mousemove", function(e) {
					return g.ontouchmove(e, !0)
				}), g.opt.grabcursorenabled && f.cursorgrabvalue && g.css(x(o.body), {
					cursor: f.cursorgrabvalue
				})), g.bind(o, "mouseup", g.ontouchend), g.zoom && (g.opt.dblclickzoom && g.bind(o, "dblclick", g.doZoom), g.ongesturezoom && g.bind(o, "gestureend", g.ongesturezoom))
			}, this.doc[0].readyState && "complete" == this.doc[0].readyState && setTimeout(function() {
				m.call(g.doc[0], !1)
			}, 500), g.bind(this.doc, "load", m))
		}, this.showCursor = function(e, o) {
			g.cursortimeout && (clearTimeout(g.cursortimeout), g.cursortimeout = 0), g.rail && (g.autohidedom && (g.autohidedom.stop().css({
				opacity: g.opt.cursoropacitymax
			}), g.cursoractive = !0), g.rail.drag && 1 == g.rail.drag.pt || (void 0 !== e && !1 !== e && (g.scroll.y = Math.round(+e / g.scrollratio.y)), void 0 !== o && (g.scroll.x = Math.round(+o / g.scrollratio.x))), g.cursor.css({
				height: g.cursorheight,
				top: g.scroll.y
			}), g.cursorh && (o = g.hasreversehr ? g.scrollvaluemaxw - g.scroll.x : g.scroll.x, !g.rail.align && g.rail.visibility ? g.cursorh.css({
				width: g.cursorwidth,
				left: o + g.rail.width
			}) : g.cursorh.css({
				width: g.cursorwidth,
				left: o
			}), g.cursoractive = !0), g.zoom && g.zoom.stop().css({
				opacity: g.opt.cursoropacitymax
			}))
			...
			g.cursortimeout || g.rail && g.autohidedom && (g.hasmousefocus && "leave" == g.opt.autohidemode || (g.cursortimeout = setTimeout(function() {
				g.rail.active && g.showonmouseevent || (g.autohidedom.stop().animate({
					...
					opacity: g.opt.cursoropacitymin
				}), g.cursoractive = !1), g.cursortimeout = 0
			...
			if (g.view = {
				...
				}, g.page = o || g.getContentSize(), g.page.maxh = Math.max(0, g.page.h - g.view.h), g.page.maxw = Math.max(0, g.page.w - g.view.w), g.page.maxh == t && g.page.maxw == r && g.view.w == n && g.view.h == i) {
			...
			"mousewheel" == o ? window.addEventListener || "onwheel" in document ? g._bind(n, "wheel", t, r || !1) : (i = void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", a(n, i, t, r || !1), "DOMMouseScroll" == i && a(n, "MozMousePixelScroll", t, r || !1)) : n.addEventListener ? (f.cantouch && /mouseup|mousedown|mousemove/.test(o) && (i = "mousedown" == o ? "touchstart" : "mouseup" == o ? "touchend" : "touchmove", g._bind(n, i, function(e) {
				var o;
				e.touches ? e.touches.length < 2 && ((o = e.touches.length ? e.touches[0] : e).original = e, t.call(this, o)) : e.changedTouches && ((o = e.changedTouches[0]).original = e, t.call(this, o))
			}, r || !1)), g._bind(n, o, t, r || !1), f.cantouch && "mouseup" == o && g._bind(n, "touchcancel", t, r || !1)) : g._bind(n, o, function(e) {
				return (e = e || window.event || !1) && e.srcElement && (e.target = e.srcElement), "pageY" in e || (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop), !1 !== t.call(n, e) && !1 !== r || g.cancelEvent(e)
			})
			...
			return e && ((e = e.original || e).preventDefault(), e.stopPropagation(), e.preventManipulation && e.preventManipulation()), !1
			...
			return g.railh && (0 == g.page.maxw || !g.ispage && "none" == g.win.css("display") || (g.railh.visibility = !0, g.railh.css("display", "block"))), g
		}, this.hideRail = function() {
			return g.visibility = !1, g.rail.visibility = !1, g.rail.css("display", "none"), g
		}, this.hideRailHr = function() {
			return g.railh && (g.railh.visibility = !1, g.railh.css("display", "none")), g
		}, this.show = function() {
			...
			if (!g.wheelprevented) {
				if (g.railslocked) return g.debounced("checkunlock", g.resize, 250), !0;
				if (g.rail.drag) return g.cancelEvent(e);
				if ("auto" == g.opt.oneaxismousemode && 0 != e.deltaX && (g.opt.oneaxismousemode = !1), g.opt.oneaxismousemode && 0 == e.deltaX && !g.rail.scrollable) return !g.railh || !g.railh.scrollable || g.onmousewheelhr(e);
				var o = +new Date,
					t = !1;
				if (g.opt.preservenativescrolling && g.checkarea + 600 < o && (g.nativescrollingarea = g.isScrollable(e), t = !0), g.checkarea = o, g.nativescrollingarea) return !0;
				t = d(e, !1, t);
			...
			if (!g.wheelprevented) {
				...
				var o = +new Date,
					t = !1;
				return g.opt.preservenativescrolling && g.checkarea + 600 < o && (g.nativescrollingarea = g.isScrollable(e), t = !0), g.checkarea = o, !!g.nativescrollingarea || (g.railslocked ? g.cancelEvent(e) : d(e, !0, t))
			}
		}, this.stop = function() {
			...
			o = o ? 20 < e ? e : 0 : g.getTransitionSpeed(e), e = o ? f.prefixstyle + "transform " + o + "ms ease-out" : "";
			return g.lasttransitionstyle && g.lasttransitionstyle == e || (g.lasttransitionstyle = e, g.doc.css(f.transitionstyle, e)), o
			...
			var o = g.getScrollTop(),
				t = g.getScrollLeft();
			return ((g.newscrolly - o) * (n - o) < 0 || (g.newscrollx - t) * (i - t) < 0) && g.cancelScroll(), 0 == g.opt.bouncescroll && (n < 0 ? n = 0 : n > g.page.maxh && (n = g.page.maxh), i < 0 ? i = 0 : i > g.page.maxw && (i = g.page.maxw)), (!g.scrollrunning || i != g.newscrollx || n != g.newscrolly) && (g.newscrolly = n, g.newscrollx = i, g.newscrollspeed = e || !1, !g.timer && void(g.timer = setTimeout(function() {
				var e = g.getScrollTop(),
					o = g.getScrollLeft(),
					t = {};
				...
				g.newscrollspeed && g.newscrollspeed <= 1 && (t *= g.newscrollspeed), g.prepareTransition(t, !0), g.timerscroll && g.timerscroll.tm && clearInterval(g.timerscroll.tm), 0 < t && (!g.scrollrunning && g.onscrollstart && (r = {
					type: "scrollstart",
					current: {
						x: o,
						y: e
					...
					speed: t
				}, g.onscrollstart.call(g, r)), f.transitionend ? g.scrollendtrapped || (g.scrollendtrapped = !0, g.bind(g.doc, f.transitionend, g.onScrollTransitionEnd, !1)) : (g.scrollendtrapped && clearTimeout(g.scrollendtrapped), g.scrollendtrapped = setTimeout(g.onScrollTransitionEnd, t)), o = o, g.timerscroll = {
				...
				}, 60))), g.synched("doScroll-set", function() {
					g.timer = 0, g.scrollendtrapped && (g.scrollrunning = !0), g.setScrollTop(g.newscrolly), g.setScrollLeft(g.newscrollx), g.scrollendtrapped || g.onScrollTransitionEnd()
				})
			}, 50)))
			...
			var e = g.getScrollTop(),
				o = g.getScrollLeft();
			return g.scrollrunning = !1, f.transitionend || clearTimeout(f.transitionend), g.scrollendtrapped = !1, g._unbind(g.doc[0], f.transitionend, g.onScrollTransitionEnd), g.prepareTransition(0), g.setScrollTop(e), g.railh && g.setScrollLeft(o), g.timerscroll && g.timerscroll.tm && clearInterval(g.timerscroll.tm), g.timerscroll = !1, g.cursorfreezed = !1, g.showCursor(e, o), g
		}, this.onScrollTransitionEnd = function() {
			g.scrollendtrapped && g._unbind(g.doc[0], f.transitionend, g.onScrollTransitionEnd), g.scrollendtrapped = !1, g.prepareTransition(0), g.timerscroll && g.timerscroll.tm && clearInterval(g.timerscroll.tm), g.timerscroll = !1;
			var e = g.getScrollTop(),
				o = g.getScrollLeft();
			if (g.setScrollTop(e), g.railh && g.setScrollLeft(o), g.noticeCursor(!1, e, o), g.cursorfreezed = !1, e < 0 ? e = 0 : e > g.page.maxh && (e = g.page.maxh), o < 0 ? o = 0 : o > g.page.maxw && (o = g.page.maxw), e != g.newscrolly || o != g.newscrollx) return g.doScrollPos(o, e, g.opt.snapbackspeed);
			g.onscrollend && g.scrollrunning && g.triggerScrollEnd(), g.scrollrunning = !1
		}) : (this.doScrollLeft = function(e, o) {
			var t = g.scrollrunning ? g.newscrolly : g.getScrollTop();
			g.doScrollPos(e, t, o)
		}, this.doScrollTop = function(e, o) {
			...
			var r = g.getScrollTop(),
				i = g.getScrollLeft();
			((g.newscrolly - r) * (o - r) < 0 || (g.newscrollx - i) * (e - i) < 0) && g.cancelScroll(), g.newscrolly = o, g.newscrollx = e, g.bouncescroll && g.rail.visibility || (g.newscrolly < 0 ? g.newscrolly = 0 : g.newscrolly > g.page.maxh && (g.newscrolly = g.page.maxh)), g.bouncescroll && g.railh.visibility || (g.newscrollx < 0 ? g.newscrollx = 0 : g.newscrollx > g.page.maxw && (g.newscrollx = g.page.maxw)), g.dst = {}, g.dst.x = e - i, g.dst.y = o - r, g.dst.px = i, g.dst.py = r;
			var n = Math.round(Math.sqrt(Math.pow(g.dst.x, 2) + Math.pow(g.dst.y, 2)));
			g.dst.ax = g.dst.x / n, g.dst.ay = g.dst.y / n;
			var s = 0,
				l = n;
			0 == g.dst.x ? (s = r, l = o, g.dst.ay = 1, g.dst.py = 0) : 0 == g.dst.y && (s = i, l = e, g.dst.ax = 1, g.dst.px = 0);
			var a, n = g.getTransitionSpeed(n);
			t && t <= 1 && (n *= t), g.bzscroll = 0 < n && (g.bzscroll ? g.bzscroll.update(l, n) : new c(s, l, n, 0, 1, 0, 1)), g.timer || ((r == g.page.maxh && o >= g.page.maxh || i == g.page.maxw && e >= g.page.maxw) && g.checkContentSize(), a = 1, g.cancelAnimationFrame = !1, g.timer = 1, g.onscrollstart && !g.scrollrunning && (n = {
				type: "scrollstart",
				current: {
					x: i,
					y: r
				...
				speed: n
			}, g.onscrollstart.call(g, n)), function e() {
				if (g.cancelAnimationFrame) return !0;
				if (g.scrollrunning = !0, a = 1 - a) return g.timer = h(e) || 1;
				var o, t = 0,
					r = n = g.getScrollTop();
				g.dst.ay ? (((i = (r = g.bzscroll ? g.dst.py + g.bzscroll.getNow() * g.dst.ay : g.newscrolly) - n) < 0 && r < g.newscrolly || 0 < i && r > g.newscrolly) && (r = g.newscrolly), g.setScrollTop(r), r == g.newscrolly && (t = 1)) : t = 1;
				var i, n = o = g.getScrollLeft();
				g.dst.ax ? (((i = (n = g.bzscroll ? g.dst.px + g.bzscroll.getNow() * g.dst.ax : g.newscrollx) - o) < 0 && n < g.newscrollx || 0 < i && n > g.newscrollx) && (n = g.newscrollx), g.setScrollLeft(n), n == g.newscrollx && (t += 1)) : t += 1, 2 == t ? (g.timer = 0, g.cursorfreezed = !1, g.bzscroll = !1, g.scrollrunning = !1, r < 0 ? r = 0 : r > g.page.maxh && (r = g.page.maxh), n < 0 ? n = 0 : n > g.page.maxw && (n = g.page.maxw), n != g.newscrollx || r != g.newscrolly ? g.doScrollPos(n, r) : g.onscrollend && g.triggerScrollEnd()) : g.timer = h(e) || 1
			}(), (r == g.page.maxh && r <= o || i == g.page.maxw && i <= e) && g.checkContentSize(), g.noticeCursor())
		}, this.cancelScroll = function() {
			...
			i < 0 && (i = 0), g.synched("scroll", function() {
				g.setScrollTop(i), g.setScrollLeft(r)
			})
		}, this.cancelScroll = function() {}), this.doScrollBy = function(e, o) {
			var t = 0;
			t = o ? Math.floor((g.scroll.y - e) * g.scrollratio.y) : (g.timer ? g.newscrolly : g.getScrollTop(!0)) - e, g.bouncescroll && (t < -(r = Math.round(g.view.h / 2)) ? t = -r : t > g.page.maxh + r && (t = g.page.maxh + r)), g.cursorfreezed = !1;
			var r = g.getScrollTop(!0);
			return t < 0 && r <= 0 ? g.noticeCursor() : t > g.page.maxh && r >= g.page.maxh ? (g.checkContentSize(), g.noticeCursor()) : void g.doScrollTop(t)
		}, this.doScrollLeftBy = function(e, o) {
			var t = 0;
			t = o ? Math.floor((g.scroll.x - e) * g.scrollratio.x) : (g.timer ? g.newscrollx : g.getScrollLeft(!0)) - e, g.bouncescroll && (t < -(r = Math.round(g.view.w / 2)) ? t = -r : t > g.page.maxw + r && (t = g.page.maxw + r)), g.cursorfreezed = !1;
			...
			o < 0 ? o = 0 : o > g.page.maxh && (o = g.page.maxh), g.cursorfreezed = !1, g.doScrollTop(e)
		...
		}, g.bind(g.docscroll, "scroll", g.onscroll), this.doZoomIn = function(e) {
			if (!g.zoomactive) {
				g.zoomactive = !0, g.zoomrestore = {
					style: {}
				};
				var o, t = ["position", "top", "left", "zIndex", "backgroundColor", "marginTop", "marginBottom", "marginLeft", "marginRight"],
					r = g.win[0].style;
				for (o in t) {
					var i = t[o];
					g.zoomrestore.style[i] = void 0 !== r[i] ? r[i] : ""
				}
				g.zoomrestore.style.width = g.win.css("width"), g.zoomrestore.style.height = g.win.css("height"), g.zoomrestore.padding = {
					w: g.win.outerWidth() - g.win.width(),
					h: g.win.outerHeight() - g.win.height()
				}, f.isios4 && (g.zoomrestore.scrollTop = x(window).scrollTop(), x(window).scrollTop(0)), g.win.css({
				...
				return "" != n && !/transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(n) || g.win.css("backgroundColor", "#fff"), g.rail.css({
					"z-index": y + 101
				}), g.zoom.css({
					"z-index": y + 102
				}), g.zoom.css("backgroundPosition", "0px -18px"), g.resizeZoom(), g.onzoomin && g.onzoomin.call(g), g.cancelEvent(e)
			}
		}, this.doZoomOut = function(e) {
			if (g.zoomactive) return g.zoomactive = !1, g.win.css("margin", ""), g.win.css(g.zoomrestore.style), f.isios4 && x(window).scrollTop(g.zoomrestore.scrollTop), g.rail.css({
				"z-index": g.zindex
			}), g.zoom.css({
				"z-index": g.zindex
			}), g.zoomrestore = !1, g.zoom.css("backgroundPosition", "0px 0px"), g.onResize(), g.onzoomout && g.onzoomout.call(g), g.cancelEvent(e)
		}, this.doZoom = function(e) {
			return g.zoomactive ? g.doZoomOut(e) : g.doZoomIn(e)
		}, this.resizeZoom = function() {
			var e;
			g.zoomactive && (e = g.getScrollTop(), g.win.css({
				width: x(window).width() - g.zoomrestore.padding.w + "px",
				height: x(window).height() - g.zoomrestore.padding.h + "px"
			}), g.onResize(), g.setScrollTop(Math.min(g.page.maxh, e)))
		}, this.init(), x.nicescroll.push(this)
	}
	var n, S = window.MutationObserver || window.WebKitMutationObserver || !1,
		z = {
			zindex: "auto",
			cursoropacitymin: 0,
			cursoropacitymax: 1,
		...
		T = function(e) {
			...
			this.nc = e, this.lastx = 0, this.lasty = 0, this.speedx = 0, this.speedy = 0, this.lasttime = 0, this.steptime = 0, this.snapx = !1, this.snapy = !1, this.demulx = 0, this.demuly = 0, this.lastscrollx = -1, this.lastscrolly = -1, this.chkx = 0, this.chky = 0, this.timer = 0, this.time = function() {
				...
				d.snapx = t < 0 || t > d.nc.page.maxw, d.snapy = n < 0 || n > d.nc.page.maxh, d.speedx = i, d.speedy = r, d.lastx = e, d.lasty = o
			}, this.stop = function() {
				...
				var o = d.time(),
					...
					i = d.nc.page.maxh,
					n = d.nc.page.maxw;
				d.speedx = 0 < n ? Math.min(60, d.speedx) : 0, d.speedy = 0 < i ? Math.min(60, d.speedy) : 0;
				t = t && o - t <= 60;
				(e < 0 || i < e || r < 0 || n < r) && (t = !1);
				var s, l, a, c, r = !(!d.speedy || !t) && d.speedy,
					t = !(!d.speedx || !t) && d.speedx;
				r || t ? (50 < (s = Math.max(16, d.steptime)) && (t = s / 50, d.speedx *= t, d.speedy *= t, s = 50), d.demulxy = 0, d.lastscrollx = d.nc.getScrollLeft(), d.chkx = d.lastscrollx, d.lastscrolly = d.nc.getScrollTop(), d.chky = d.lastscrolly, l = d.lastscrollx, a = d.lastscrolly, (c = function() {
					var e = 600 < d.time() - o ? .04 : .02;
					d.speedx && (l = Math.floor(d.lastscrollx - d.speedx * (1 - d.demulxy)), ((d.lastscrollx = l) < 0 || n < l) && (e = .1)), d.speedy && (a = Math.floor(d.lastscrolly - d.speedy * (1 - d.demulxy)), ((d.lastscrolly = a) < 0 || i < a) && (e = .1)), d.demulxy = Math.min(1, d.demulxy + e), d.nc.synched("domomentum2d", function() {
						d.speedx && (d.nc.getScrollLeft() != d.chkx && d.stop(), d.chkx = l, d.nc.setScrollLeft(l)), d.speedy && (d.nc.getScrollTop() != d.chky && d.stop(), d.chky = a, d.nc.setScrollTop(a)), d.timer || (d.nc.hideCursor(), d.doSnapy(l, a))
	...
	x.cssHooks.pageXOffset = {
		...
		set: function(e, o) {
			var t = x.data(e, "__nicescroll") || !1;
			return t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : l.call(e, o), this
		}
	...
	function a(e) {
		...
		void 0 === o && ("object" != typeof e || "jquery" in e || (o = e, e = !1)), o = x.extend({}, o);
		var t = new a;
		void 0 === o && (o = {}), e && (o.doc = x(e), o.win = x(this));
		var r = !("doc" in o);
		return r || "win" in o || (o.win = x(this)), this.each(function() {
			var e = x(this).data("__nicescroll") || !1;
			e || (o.doc = r ? x(this) : o.doc, e = new i(o, x(this)), x(this).data("__nicescroll", e)), t.push(e)
		}), 1 == t.length ? t[0] : t
	}, window.NiceScroll = {
		getjQuery: function() {
			return e
...
! function(s, t, e, n) {
	...
	function o(i, t) {
		this.element = i, this.$el = s(i), this._defaults = l, this._name = a;
		var e = this.$el.data(),
			n = {};
		for (var o in e)
			...
			} this.settings = s.extend({}, l, n, t), null == this.settings.src || this.settings.src.length < 1 ? console.log("ZoomSlider terminated - invalid input.") : this.init()
	}
	s.extend(o.prototype, {
		...
		initSlideshow: function() {
			...
			if (t._promoteChildren(), e.append(n).prependTo(this.$el), 1 == this.settings.bullets && (e.append(a), e.on("click", ".zs-bullet", (function(i) {
					t.jump(s(this).index())
		...
		jump: function(s) {
			if (s >= this.numSlides) console.log("ZoomSlider: jump(pos) aborted. supplied index out of range.");
			else if (this.pos != s)
